  ...
  return (
    <div className="login-container" style={{
      ...
      <div className="glass animate-fade" style={{ padding: '48px', width: '100%', maxWidth: '400px' }}>
        <h1 className="neon-text" style={{ fontSize: '2rem', marginBottom: '8px', textAlign: 'center', fontWeight: 700 }}>TuCooperativa</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '20px' }}>
            <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.875rem', fontWeight: 600 }}>E-mail Administrativo</label>
            <input type="email" placeholder="admin@tucooperativa.com" className="glass" style={{ 
          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <input type="password" placeholder="••••••••" className="glass" style={{ 
              width: '100%', padding: '14px', background: 'rgba(0,0,0,0.2)', color: 'white', outline: 'none' 
            }} required />
          </div>
